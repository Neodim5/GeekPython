...
if __name__ == '__main__':
    ...
    p2 = Scanner("HP", "4850", "gray", 40000)
    p3 = Xerox("Xerox", "25000", "black", 25000)
    print(p1)
    print(p2)
    print(p3)
    print(p1.retail_price)
    print(p2.retail_price)
    print(p3.retail_price)
    print(p1.wholesale_price)
    print(p2.wholesale_price)
    print(p3.wholesale_price)
